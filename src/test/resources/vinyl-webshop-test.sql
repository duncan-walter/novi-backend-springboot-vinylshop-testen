...
VALUES ('Halloween', 'Very spooky', CURRENT_TIMESTAMP, NOW()),
       ('Disco', 'Boogie woogie', CURRENT_TIMESTAMP, NOW()),
       ('Rock', 'Rock-''n-roll', CURRENT_TIMESTAMP, NOW()),
       ('Classical', '7th symphony', CURRENT_TIMESTAMP, NOW()),
       ('70''s', 'Funky!', CURRENT_TIMESTAMP, NOW());
